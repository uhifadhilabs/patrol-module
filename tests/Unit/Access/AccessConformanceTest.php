...
final class AccessConformanceTest extends AccessConformanceTestCase
{
     ...
     * patrol is field effort the organization recorded about its own work,
     * and the three word-lists are the organization's own vocabulary. The
     * photographs an observation carries ARE such a fact, and they are
     * withheld by the storage module that holds their bytes, under its own
     * concern — not by this one.
     *
